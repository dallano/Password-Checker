...
#   hash to an api. The said API then returns the remainder of the hashes that match
#   the sendt query along with a count of how many times that password has been leaked.
#   the program then compares that with the hash that wasn't sent and checks gives the
...
#   It is recommended that the user also delete their passwords from said list to ensure
#   optimal security.
#
